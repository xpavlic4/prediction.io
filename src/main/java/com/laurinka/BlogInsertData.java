...
public class BlogInsertData {

    private static final String API_KEY = "BmGW6aDNWTjN42OJSC0bElyocWUf148hqrnOSlfpzNvXwFcnbyJyGbFNF9aUA1pL";
    ...
    private static void addUsers(Client client) throws Exception {
        String[] users = { "radim", "daniel", "armin"};
